...
export const MIME_EXT: Partial<Record<Mime, string>> = {
  ...
  [Mime.IMAGE_JXL]: '.jxl',
  [Mime.ANIMATION_JXL]: '.jxl',
  [Mime.ANIMATION_UGOIRA]: '.zip',
  [Mime.APPLICATION_CBZ]: '.cbz',
  ...
  [Mime.APPLICATION_DOCX]: '.docx',
  [Mime.APPLICATION_XLSX]: '.xlsx',
  [Mime.APPLICATION_PPTX]: '.pptx',
  [Mime.APPLICATION_DOC]: '.doc',
  [Mime.APPLICATION_XLS]: '.xls',
  [Mime.APPLICATION_PPT]: '.ppt',
  [Mime.APPLICATION_EPUB]: '.epub',
  [Mime.APPLICATION_DJVU]: '.djvu',
  [Mime.APPLICATION_RTF]: '.rtf',
  [Mime.APPLICATION_PSD]: '.psd',
  [Mime.APPLICATION_CLIP]: '.clip',
  [Mime.APPLICATION_SAI2]: '.sai2',
  [Mime.APPLICATION_KRITA]: '.kra',
  [Mime.IMAGE_OPENRASTER]: '.ora',
  [Mime.APPLICATION_PAINT_DOT_NET]: '.pdn',
...
export const MIME_STRING: Partial<Record<Mime, string>> = {
  ...
  [Mime.ANIMATION_WEBP]: 'image/webp',
  ...
  [Mime.ANIMATION_JXL]: 'image/jxl',
  [Mime.ANIMATION_UGOIRA]: 'application/zip',
  [Mime.APPLICATION_FLASH]: 'application/x-shockwave-flash',
  [Mime.APPLICATION_OCTET_STREAM]: 'application/octet-stream',
  [Mime.APPLICATION_CBZ]: 'application/vnd.comicbook+zip',
  ...
  [Mime.APPLICATION_DOCX]: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
  [Mime.APPLICATION_XLSX]: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
  [Mime.APPLICATION_PPTX]: 'application/vnd.openxmlformats-officedocument.presentationml.presentation',
  [Mime.APPLICATION_DOC]: 'application/msword',
  [Mime.APPLICATION_XLS]: 'application/vnd.ms-excel',
  [Mime.APPLICATION_PPT]: 'application/vnd.ms-powerpoint',
  [Mime.APPLICATION_EPUB]: 'application/epub+zip',
  [Mime.APPLICATION_DJVU]: 'image/vnd.djvu',
  [Mime.APPLICATION_RTF]: 'application/rtf',
  ...
  [Mime.IMAGE_OPENRASTER]: 'image/openraster',
  [Mime.APPLICATION_PAINT_DOT_NET]: 'application/x-paintnet', // no official
  ...
  [Mime.UNDETERMINED_OLE]: 'application/x-ole-storage',
...
MIME_STRING[Mime.UNDETERMINED_WM] = `${Mime.AUDIO_WMA} or ${Mime.VIDEO_WMV}`;
MIME_STRING[Mime.UNDETERMINED_MP4] = `${Mime.AUDIO_MP4} or ${Mime.VIDEO_MP4}`;
MIME_STRING[Mime.UNDETERMINED_PNG] = `${Mime.IMAGE_PNG} or ${Mime.ANIMATION_APNG}`;
MIME_STRING[Mime.UNDETERMINED_WEBP] = 'image/webp, static or animated';
MIME_STRING[Mime.UNDETERMINED_JXL] = 'image/jxl, static or animated';
