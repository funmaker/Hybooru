...
Executes benchmarks and collects statistics. The response contains record counts and explain analyze generated by
benchmarking queries. While this request is being processed, benchmark summary will be printed to the standard output.
If you ever face performance issues, please include the response from this endpoint in your GitHub Issue.

**This request might take some time.**
